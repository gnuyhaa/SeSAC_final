...
from .routers import auth, parks, park_category, emotions, recommend
...
app.include_router(recommend.router) # recommend 라우터

# CORS 설정
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://growth-doctor-front.web.app", "http://localhost:3000"],  
